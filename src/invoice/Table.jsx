...
const Table = ({ selectedCar, calculateTotal, additional, discount }) => {
    return (
        <table className="min-w-full">
            ...
            <tbody>
                <tr className="border-b border-gray-200">
                    ...
                    <td className="hidden px-3 py-5 text-right text-sm text-gray-500 sm:table-cell">{selectedCar ? `$${calculateTotal()}` : '-'}</td>
                    <td className="py-5 pl-3 pr-4 text-right text-sm text-gray-500 sm:pr-0">{selectedCar ? `$${calculateTotal()}` : '-'}</td>
                </tr>
            </tbody>
            <tfoot>
                <tr>
                    ...
                    <td className="pl-3 pr-6 pt-6 text-right text-sm text-gray-500 sm:pr-0">{selectedCar ? `$${calculateTotal()}` : '-'}</td>
                </tr>
                <tr>
